...
def test_user_with_no_perm_cant_create_category(check_access_denied, user_without_perm):
    ...
    """
    response = check_access_denied(user_without_perm, "categories-list", "post")
...
def test_user_with_perm_can_edit_category(api_client, user_with_perm):
    ...
    category = Category.objects.create(name="Old Name", slug="old-name", description="Old description")
...
def test_user_with_perm_can_delete_category(api_client, user_with_perm):
    ...
    category = Category.objects.create(name="ToDelete", slug="to-delete", description="Temp")
